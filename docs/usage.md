...
2. Upload your files for processing
3. Once complete, ask questions based on your files!
...
| Top K             | Number of most similar nodes to retrieve in response to a query        | 3                             |
